...
var modctx = DMI.modctx = {
	...
	unitcommands: {
		...
		bravemount: _num,
		bugshape: _str_num,
		bugswarmshape: _str_num,
		bugswarmuwshape: _str_num,
		buguwshape: _str_num,
		chaosrecscale: _num,
		chorusmaster: _bool,
		chorusslave: _bool,
		...
		noreqlab: _bool,
		noreqtemple: _bool,
		nospiritform: function(c,a,t){ delete modctx[t]['spiritform']; },
		nothrowoff: _ignore,
		noweapon: _ignore,
		orderrecscale: _num,
		plaguedoctor: _num,
...
//~ undead. Desert Tombs C'tis has this attribute.
		...
		caveres: _num,
		cavetemplecost: _num,
		coastcom: function(c,a,t){ modctx[t]['coastcom'].push(argref(a)); },
		coastfortcom: _ref,
		coastfortrec: _ref,
		coastrec: function(c,a,t){ modctx[t]['coastrec'].push(argref(a)); },
		...
		undeadreanim: _bool,
		uwcom: function(c,a,t){ modctx[t]['uwcom'].push(argref(a)); },
		uwdefcom1: _ref,
		uwdefcom2: _ref,
		uwdefmult1: _num,
		uwdefmult1b: _num,
		...
		uwdefunit2: _ref,
		uwdefunit2b: _ref,
		uwrec: function(c,a,t){ modctx[t]['uwunit'].push(argref(a)); },
		uwwallcom: _ref,
		uwwallmult: _num,
		uwwallunit: _ref,
		viewallbat: _bool,
