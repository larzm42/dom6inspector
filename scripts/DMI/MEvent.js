...
MEvent.bitfieldValues = function(bitfield, masks_dict) {
	var newValues=[];
	if (!bitfield) {
		return newValues;
	}
...
//	dbase key	displayed key		function/dict to format value
	...
	'req_minpop',	'minimum pop', function(v){ return v*10; },
	...
	'req_unclaimedthrone', 'unclaimed throne', MEvent.formatYesNo,
	'req_unclaimedthronesite', 'unclaimed throne present', MEvent.formatYesNo,
	...
	'req_worlditem', 'item in world', Utils.itemRef,
	'req_noworlditem', 'item not in world', Utils.itemRef,
	'req_nomnr', 'does not exist', MEvent.monsterArr,
	'req_norealmnr', 'does not exist', MEvent.monsterArr,
	'req_mnr', 'exists', MEvent.monsterArr,
	'req_mnrbs', 'base shape exists', MEvent.monsterArr,
	'req_monsterbs', 'base shape present', MEvent.monsterArr,
	'req_2monsters', 'two monsters present', MEvent.monsterArr,
	'req_5monsters', 'five monsters present', MEvent.monsterArr,
	...
	'req_notforally', 'not nation', MEvent.nationArr,
	...
	'req_notpoptype',	'population type',
	'req_turn',	'minimum turn',
	'req_playerturn', 'minimum turn (player nations)',
	'req_maxturn',	'maximum turn',
	'req_cataclysmturn', 'turn relative to cataclysm',
	...
	'req_pathglamour', 'glamour mage level',
	'req_nopathwater', 'no water mage at level',
	'req_nopathholy', 'no holy mage at level',
	...
	'req_orpathearth', 'earth or higher path',
	'req_orpathglamour', 'glamour or higher path',
	...
	'req_targnoaff', 'target', function(v) { return 'cannot have '+DMI.MAffliction.lookupByNumber(v)},
	'req_targaff', 'target', function(v) { return 'must have '+DMI.MAffliction.lookupByNumber(v)},
	'req_targnomnr', 'target', function(v) { return 'cannot be '+Utils.unitRef(v)},
	'req_targnorealmnr', 'target', function(v) { return 'cannot be '+Utils.unitRef(v)},
	'req_targmnr', 'target monster', MEvent.monsterArr,
	'req_targrealmnr', 'target monster', MEvent.monsterArr,
	...
	'req_luckrare', 'luck-adjusted chance', Format.Percent,
	'req_dominionrare', 'dominion-adjusted chance', Format.Percent,
	'req_worldunitrare', 'world-unit-adjusted chance', Format.Percent,
	'req_turnrare', 'rare', Format.Percent,
	...
	'req_targnoitem', 'no item', MEvent.itemArr,
	...
	'req_indepok', 'happens to independents', MEvent.formatYesNo,
	...
	'req_notcode', 'event code not set',
	'req_notanycode', 'event code absent everywhere',

	'req_maxpop', 'maximum population', function(v){ return v*10; },
	'req_targgod',	'target', {'0': 'cannot be god', '1': 'must be god'},
	'req_targprophet',	'target', {'0': 'cannot be prophet', '1': 'must be prophet'},
	'req_targhumanoid',	'target', {'0': 'cannot have hands', '1': 'must have hands'},
	'req_targmale',	'target', {'0': 'must be female', '1': 'must be male'},
	'req_targsneaking', 'target', {'0': 'must not be sneaking', '1': 'must be sneaking'},
	'req_targimmobile',	'target', {'0': 'must not be immobile', '1': 'must be immobile'},
	'req_targmindless',	'target', {'0': 'must not be mindless', '1': 'must be mindless'},
	'req_targsight',	'target', {'0': 'cannot have sight', '1': 'must have sight'},
	'req_targanimal',	'target', {'0': 'must not be animal', '1': 'must be animal'},
	'req_targundead', 'target', {'0': 'must not be undead', '1': 'must be undead'},
	'req_targdemon', 'target', {'0': 'must not be demon', '1': 'must be demon'},
	'req_targfreeitemslot', 'target', function(v) { return 'must have a free item slot'; },
	'req_targmanygems',	'target', function(v) { return 'must have >d20 '+MEvent.magicPathArr(v)+' gems';},
	'req_targhorrormark',	'target ', function(v) { return 'must have horror mark '+v},
	'req_targowner',	'target', function(v) { return 'owned by ' + Utils.nationRef(v); },
	'req_targnotowner',	'target', function(v) { return 'not owned by ' + Utils.nationRef(v); },
	'req_targforeignok', 'target', { '0': 'must be owned by province owner', '1': 'may be owned by nation other than province owner'},
	'req_targminsize', 'target', function(v) { return 'must be size '+v+' or larger'; },
	'req_targmaxsize', 'target', function(v) { return 'must be size '+v+' or smaller'; },
	'req_targinsane', 'target', {'0': 'must not be insane', '1': 'must be insane'},
	'req_targnoorder', 'target', {
		'0': 'must not be defending',
		'2': 'must not be sneaking',
		'3': 'must not be patrolling',
		'4': 'must not be researching',
		'6': 'must not be preaching',
		'7': 'must not be site searching',
		'8': 'must not be blood hunting',
		'14': 'must not be calling God',
		'17': 'must not be summoning allies',
		'18': 'must not be building lab',
		'19': 'must not be building temple',
		'20': 'must not be building fort',
		'44': 'must not be demolishing fort',
		'45': 'must not be demolishing lab',
		'50': 'must not be entering site (except scry)',
		'52': 'must not be void summoning',
		'100': 'must not be investigating',
		'101': 'must not be continuing',
		'102': 'must not be accepting',
		'103': 'must not be declining',
		'105': 'must not be attacking',
		'106': 'must not be performing diplomacy',
		'107': 'must not be performing subterfuge',
		'108': 'must not be doing magic'
		},
	'req_targminmorale', 'target', function(v) { return 'cannot have morale < '+v;},
	'req_targmaxmorale', 'target', function(v) { return 'cannot have morale > '+v;},
	'req_targally', 'target', function(v) { return 'owned by ' + Utils.nationRef(v) +' or their ally'; },
	'req_targnotally', 'target', function(v) { return 'not owned by ' + Utils.nationRef(v) +' or their ally'; },
	'req_targseductions', 'target', function(v) { return v +' successful seductions'; },
	'req_targminkills', 'target', function(v) { return 'kill count >= ' + v; },
	'req_targmaxkills', 'target', function(v) { return 'kill count <= ' + v; },

	'req_ai', 'nation', {'0': 'must not be ai', '1': 'must be ai'},
	'req_default', 'internal default-event guard',
	'req_unitrecruit', 'recruitable unit', MEvent.monsterArr,
	'req_godalive', 'pretender awake and alive', MEvent.formatYesNo,
	'req_arenadone', 'arena', {'0': 'did not happen this turn', '1': 'happened this turn'},
	'req_crystal', 'terrain', {'0': 'must not be crystal cave', '1': 'must be crystal cave'},
	'req_deadmnr', 'must be dead', Utils.unitRef,
	'req_deep', 'terrain', {'0': 'must not be deep sea', '1': 'must be deep sea'},
	'req_drip', 'terrain', {'0': 'must not cave drip', '1': 'must cave drip'},
	'req_enchnearby', 'nearby enchantment', MEvent.formatReqSpell,
	'req_enchtarget', 'local enchantment', MEvent.formatReqSpell,
	'req_forestcave', 'terrain', {'0': 'must not be forest cave', '1': 'must forest cave'},
	'req_fortid', 'required fort', {
		'1': 'Palisades',
	...
	'req_godawake', 'event owner\'s god', { '0': 'must not be awake', '1':'must be awake'},
	'req_pretawake', 'event owner\'s god', { '0': 'must not be awake', '1':'must be awake'},
	'req_godismnr', 'event owner\'s god', function(v) { return 'must be '+(v.map(Utils.unitRef).join(' or '));},
	'req_godisnotmnr', 'event owner\'s god', function(v) { return 'must not be '+Utils.unitRef(v);},
	'req_pretismnr', 'event owner\'s god', function(v) { return 'must be '+(v.map(Utils.unitRef).join(' or '));},
	'req_gorge', 'terrain', { '0': 'must not be gorge sea', '1':'must be gorge sea'},
	'req_kelp', 'terrain', { '0': 'must not be kelp sea', '1':'must be kelp sea'},
	'req_maxcorpses', 'max corpses',
	'req_mincorpses', 'min corpses',
	'req_maxglobals', 'max active globals',
	'req_minglobals', 'min active globals',
	'req_minresearch', 'min research', function(v,o) { return o['req_school'] ? modctx.school_lookup[v] + ' ' + o['req_school'] : modctx.school_lookup[v]},
	'req_month', 'month',
	'req_nativesoil', 'native soil',
	'req_nearbycapital', 'nearby capital',
	'req_nearbythrone', 'nearby throne',
	'req_nonation', 'not in game', Utils.nationRef,
	'req_nopathglamour', 'no glamour mage',function(v) { return 'level >= '+v},
	'req_pathgems', 'must have at least', function(v,o) { return MEvent.gemArr(o['req_path'], o, ' x '+v);},
	'req_plane', 'location', function(v) { v = parseInt(v); if (v >=1) return 'other map planes'; if (v === 0) return 'default plane (demiurgia)'; if(v === -1) return 'cave plane'; if (v === -2) return 'nexus plane';},
	'req_realmnr', 'exists', MEvent.monsterArr,
	'req_void', 'location', { '0' : 'cannot be nexus', '1': 'must be nexus'},
	'req_voidok', 'location', { '0' : 'cannot be nexus', '1': 'can be nexus'},
...
//	dbase key	displayed key		function/dict to format value
	...
	'worldstorm', 'world storm', function(v){ return ' '; },
	'worldage',	'world ages',
	...
	'forceexactgold',	'gold', Format.Signed,
	'forcegold',	'gold', Format.Signed,
	...
	'killpop', 'kill population', function(v){ return v*10; },
	'sinkprovince', 'sink province', MEvent.formatYesNo,
	'incpop',	'increase pop',
	...
	'healaff', 'heal affliction', MEvent.gainaffArr,
	...
	'force1d3vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 1d3'); },
	'force1d6vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 1d6'); },
	'force2d4vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 2d4'); },
	'force2d6vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 2d6'); },
	'force3d6vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 3d6'); },
	'force4d6vis', 'gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 4d6'); },
	'gemloss',	'lose gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 3d6'); },
	'gemlosslarge',	'lose gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 4d6'); },
	'gemlosssmall',	'lose gems',	function(v,o){ return MEvent.gemArr(v, o, ' x 2d6'); },
	'gemloss1d6', 'lose gems', function(v,o){ return MEvent.gemArr(v, o, ' x 1d6'); },
	'allvis', 'gems', function(v){ return v+' of every type'; },
	...
	'bloodboost',	'boost blood', function(v,o){ return v == 1 ? '1' : Utils.unitRef(v);  },
	'holyboost',	'boost holy', function(v,o){ return v == 1 ? '1' : Utils.unitRef(v);  },
	'glamourboost',	'boost glamour', function(v,o){ return v == 1 ? '1' : Utils.unitRef(v);  },

	'stealthcom',	'stealthy commander', MEvent.monsterArr,
	'assassin',	'assassin', MEvent.monsterArr,
	'assassinationbattle', 'reserved assassination marker',
	'bodyguard', 'bodyguard', MEvent.monsterArr,
	...
	'20d6units', 'units', function(v,o){ return MEvent.monsterArr(v, o, ' x 20d6'); },
	...
	'maybeaddsite', 'possible new site', MEvent.formatNewSite,
	'maybehiddensite', 'possible hidden site', MEvent.formatNewSite,
	'removesite', 'remove site', MEvent.formatNewSite,

	'gainmark', 'gain horror mark',
	'globslots', 'global enchantment slots', Format.Signed,

	'flagland', 'event flag', {'0': 'remove', '1': 'add'},

	'nationench', 'units owned by controller of', MEvent.formatReqSpell,

	'addascension', 'required ascension points', Format.Signed,
	'addgeo', 'add terrain', function (v,o) { return Utils.renderFlags(MEvent.bitfieldValues(v, modctx.map_terrain_types_lookup), 1)},
	'addkills', 'add kill count',
	'addseductions', 'add seduction count',
	'arena', 'start arena death match', function (v,o) { return ''; },
	'arena2', 'start people\'s arena death match', function (v,o) { return ''; },
	'assfollower1', 'assassin follower 1', Utils.unitRef,
	'assfollower1d3', 'assassin follower 1d3', Utils.unitRef,
	'assfollower2', 'assassin follower 2', Utils.unitRef,
	'assfollower3', 'assassin follower 3', Utils.unitRef,
	'assowner', 'assassins owned by', Utils.nationRef,
	'assownerench', 'assassins from enchantment', MEvent.formatReqSpell,
	'claimthrone', 'claim throne', function (v,o) { return ''; },
	'delay', 'next event in',
	'delay25', 'next event in (25% chance)',
	'delay50', 'next event in (50% chance)',
	'delayskip', 'delayed-event skip chance', Format.Percent,
	'codedelay', 'delay event code',
	'resetcodedelay', 'reset delayed event code',
	'resetcodedelay2', 'reset delayed event code 2',
	'purgecalendar', 'purge calendar events',
	'purgedelayed', 'purge delayed events',
	'dispglobals', 'global enchantment strength', function (v,o) { return 'reduced by '+v; },
	'forcetransform', 'transform target into', Utils.unitRef,
	'inccorpses', 'corpses', Format.Signed,
	'remgeo', 'remove terrain', function (v,o) { return Utils.renderFlags(MEvent.bitfieldValues(v, modctx.map_terrain_types_lookup), 1)},
	'kill2d6mon', 'kill', function(v,o){ return MEvent.monsterArr(v, o, ' x 2d6'); },
	'killtarg', 'kill target', function (v,o) { return ''; },
	'minascension', 'required ascension points', function (v,o) { return '>= '+v; },
	'poison', 'poison target',
	'cleartarg', 'clear event target', MEvent.formatYesNo,
	'extramsg', 'extra message to nation', Utils.nationRef,
	'eventnation', 'reserved nation marker', Utils.nationRef,
	'nextchance', 'chance for next effect', Format.Percent,
	'code2', 'event code 2',
	'resolvearena1', 'resolve arena 1',
	'resolvearena2', 'resolve arena 2',
	'setpoptype', 'set population type to',
	'setxp', 'set experience',
	]);
